...
class PlayerWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(QString(u"千鸟播放器"))
    ...
    def playFile(self,filename):
        ...
        self.ph.setCurrentSource(Phonon.MediaSource(QString(filename)))
    ...
    def menu(self):
        ...
        openFileAction=QAction(QIcon(""),u'打开(&Z)',self)
    ...
    def about(self):
        ...
        about.setWindowTitle(u'关于千鸟播放器')
        about.setText(u"千鸟播放器 是一个使用PyQt编写的简单MP3播放器\n借鉴自开源中国\n\twapznw@gmail.com")
        about.show()

    def openFile(self):
        filename=QFileDialog.getOpenFileName(self,u'打开你想听的音乐','./')
        filename=unicode(filename)
        self.filename=filename
        self.ph.setCurrentSource(Phonon.MediaSource(QString(self.filename)))
